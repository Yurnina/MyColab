...
class QStringDB():
    ...
    def initialize():
        ...
        QStringDB.btn_view_matna_mask_tip =  {   'en' : 'View trained MatNa mask',
                                                'ru' : 'Посмотреть тренированную MatNa маску',
                                                'zh' : '查看导入后的MatNa遮罩',
                                            }[lang]
                                            
        QStringDB.btn_view_matna_overlay_mask_tip =  {   'en' : 'View trained MatNa mask overlay face',
                                                        'ru' : 'Посмотреть тренированную MatNa маску поверх лица',
                                                        'zh' : '查看导入后的MatNa遮罩于脸上方',
                                                    }[lang]
