...
class InteractiveMergerSubprocessor(Subprocessor):
    ...
    class Cli(Subprocessor.Cli):
        ...
        def on_initialize(self, client_dict):
            ...
            self.matna_256_extract_func = client_dict['matna_256_extract_func']
                ...
                if cfg.type == MergerConfig.TYPE_MASKED:
                    try:
                        final_img = MergeMasked (self.predictor_func, self.predictor_input_shape,
                                                 ...
                                                 matna_256_extract_func=self.matna_256_extract_func,
                                                 cfg=cfg,
    ...
    #override
    def __init__(self, is_interactive, merger_session_filepath, predictor_func, predictor_input_shape, face_enhancer_func, matna_256_extract_func, merger_config, frames, frames_root_path, output_path, output_mask_path, model_iter, subprocess_count=4):
        if len (frames) == 0:
        ...
        self.matna_256_extract_func = matna_256_extract_func
